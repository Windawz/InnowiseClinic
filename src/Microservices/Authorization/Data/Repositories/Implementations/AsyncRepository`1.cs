...
public abstract class AsyncRepository<TEntity>(AuthorizationDbContext dbContext) : IAsyncRepository<TEntity>
    where TEntity : Entity
{
    protected AuthorizationDbContext DbContext { get; } = dbContext;
